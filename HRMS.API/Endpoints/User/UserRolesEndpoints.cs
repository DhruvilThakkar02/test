...
namespace HRMS.API.Endpoints.User
{
    public static class UserRolesEndpoints
    {
        public static void MapUserRolesEndpoints(this IEndpointRouteBuilder app)
        {
            ...
            app.MapGet("/GetUserRoles", async (IUserRolesService _rolesService, IUserRoleLogger logger) =>
            {
            ...
            app.MapGet("/GetUserRoleById/{id}", async (IUserRolesService _rolesService, int id, IUserRoleLogger logger) =>
            {
            ...
            app.MapPost("/CreateUserRole", async (UserRoleCreateRequestDto dto, IUserRolesService _rolesService, IUserRoleLogger logger) =>
            {
            ...
            /// </remarks> 
            ///<returns> A success or error response based on the operation result.</returns >
            app.MapPut("/UpdateUserRole", async (IUserRolesService _rolesService, [FromBody] UserRoleUpdateRequestDto dto, IUserRoleLogger logger) =>
            {
                var requestJson = JsonConvert.SerializeObject(dto);
                logger.LogInformation("Received request: {RequestJson}", requestJson);
            ...
            app.MapDelete("/DeleteUserRole", async (IUserRolesService _rolesService, [FromBody] UserRoleDeleteRequestDto dto, IUserRoleLogger logger) =>
            {
                var requestJson = JsonConvert.SerializeObject(dto);
                logger.LogInformation("Received request: {RequestJson}", requestJson);
